...
1–100 绝对值，量全局知名度/使用度/产业渗透力，**与 importance 正交**：importance 回答"教学中多核心"，popular 回答"世界上多广泛"。档位：81–100 极高 / 61–80 高 / 41–60 中 / 1–40 低。字段可选；未填视作未知，不参与影响力档位筛选。锚点示例：

- Python、HTTP、Linux ≈ 95+；AWS、微信 ≈ 85
- 拼多多、Okta ≈ 70（大众/行业知名，教学非主线）
- CLRS、Raft ≈ 15（教学重要但大众知名度低——importance 5 与 popular 低并存的典型）
